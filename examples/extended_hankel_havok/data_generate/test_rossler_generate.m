...
dt = 0.001;
[t, xdat] = rossler_generate(dt, 200);
...
title('Rossler System Trajectory');
axis tight
set(gca, 'FontSize', 14);
view(34, 22);
...
hold on;
p2 = plot3(xdat(1,1), xdat(1,2), xdat(1,3), 'ro', 'MarkerSize', 8, 'MarkerFaceColor', 'r', 'LineWidth', 0.25);
title('Rossler System Particle Animation');
xlabel('x_1'), ylabel('x_2'), zlabel('x_3');
axis tight;
grid on;
view(34, 22);
...
step = 100; % Skip frames for faster animation
